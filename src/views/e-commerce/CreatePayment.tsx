...
const CreatePayment = () => {
  return (
    <div className="mb-20" id="create-payment">
      <div className="grid grid-cols-6 items-start">
        <HeadingTwo>Create Payment</HeadingTwo>
      ...
      <DescriptionTextWrapper>
        ...
        <p className="mt-3">
          Create payment helps to initiate a payment through the e-commerce
          integration. It takes in the necessary information such as the amount,
          currency, and customer details and creates a payment request. This
          allows the user or customer to complete the payment using their
          preferred method (such as card or bank transfer).
        </p>
      </DescriptionTextWrapper>
      <div className="mt-7">
        ...
        <div className="mt-5">
          <Request
            requestType="POST"
            url="https://api.hydrogenpay.com/sandbox/api/v1/integration/create-payment"
          ></Request>
        </div>
      </div>
      <div className="mt-7">
      ...
      <div className="mt-7">
        ...
        <div className="mt-7 text-[14.4px]">
          <CopyBlock
            language={createPaymentResponse.language}
            text={createPaymentResponse.code}
            theme={dracula}
